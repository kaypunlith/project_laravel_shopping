                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="mb-3 col-6">
                                    ...
                                    <input class="form-control" type="text" name="name" value="{{$editproduct[0]->name}}" />
                                </div>
                                <div class="mb-3 col-6">
                                    <label for="formFile" class="form-label">Quantity</label>
                                    <input class="form-control" type="text" name="qty"  value="{{$editproduct[0]->qty}}"  />
                                </div>
                                <div class="mb-3 col-6">
                                    <label for="formFile" class="form-label">Regular Price</label>
                                    <input class="form-control" type="number" name="regular_price"  value="{{$editproduct[0]->reguler_price}}"  />
                                </div>
                                <div class="mb-3 col-6">
                                    <label for="formFile" class="form-label">Sale Price</label>
                                    <input class="form-control" type="number" name="sale_price" value="{{$editproduct[0]->sale_peice}}"  />
                                </div>
                                <div class="mb-3 col-6">
